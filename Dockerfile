...
LABEL org.opencontainers.image.title="iotc-data-browser"
LABEL org.opencontainers.image.url="https://github.com/iotc-secretariat/iotc-data-browser"
LABEL org.opencontainers.image.source="https://github.com/iotc-secretariat/iotc-data-browser"
LABEL org.opencontainers.image.description="IOTC Data Browser"
...
#copy app
COPY . /srv/iotc-data-browser
#etc dirs (for config)
RUN mkdir -p /etc/iotc-data-browser/

EXPOSE 3838

CMD ["R", "-e shiny::runApp('/srv/iotc-data-browser',port=3838,host='0.0.0.0')"]